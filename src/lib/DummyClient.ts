...
export class DummyClient {
  ...
  send_dummy_proc(res: NetPacket) {
    switch (res.no) {
      case NS_Echo.NO:
        recv_NS_Echo(this, res as NS_Echo);
        break;
      case NS_Login.NO:
        recv_NS_Login(this, res as NS_Login);
        break;
      case NS_Ready.NO:
        recv_NS_Ready(this, res as NS_Ready);
        break;
      case NN_Ready_Join.NO:
        recv_NN_Ready_Join(this, res as NN_Ready_Join);
        break;
      case NN_Ready_Start.NO:
        recv_NN_Ready_Start(this, res as NN_Ready_Start);
        break;
      case NS_Game_LoadComplete.NO:
        recv_NS_Game_LoadComplete(this, res as NS_Game_LoadComplete);
        break;
      case NN_Game_Start.NO:
        recv_NN_Game_Start(this, res as NN_Game_Start);
        break;
      ...
      case NS_Game_Finish.NO:
        recv_NS_Game_Finish(this, res as NS_Game_Finish);
        break;
      default:
